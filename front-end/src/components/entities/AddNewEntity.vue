<template>
    <div id="Entities_forms">
        ...
        <div v-if="logged_in">
            ...
            <div
                v-if="entity_type == 'medication'"
                class="flex flex-col items-center ml-auto mr-auto pt-24 mt-3 mb-4"
            >
                <table
                ...
                >
                    <thead>
                        <tr>
                            <th
                                v-if="create_mode"
                                class="text-lg text-white text-2xl w-full bg-blue-500 rounded-t-2xl border-teal border-b-2 border-r-2"
                                colspan="2"
                            >
                    ...
                    <tbody>
                        <tr class="bg-blue-100">
                            <td class="border-blue-300 border-2 py-2">
                                <b class="text-xl">Medication name</b>
                            </td>
                            <td
                                v-if="create_mode == true"
                                class="border-blue-300 border-2 py-2"
                            >
                                <input
                        ...
                        <tr class="bg-blue-100">
                            <td class="border-blue-300 border-2 py-2">
                                ...
                                <button
                                    @click="add_effect()"
                                    class="text-white shadow-lg transition duration-300 ease-in-out bg-blue-500 hover:bg-blue-700 transform hover:-translate-y-1 hover:scale-110 rounded-lg py-1 px-4 m-1"
                                >
                                    add
                                </button>
                            </td>
                            <td class="border-blue-300 border-2 py-2">
                                ...
                                >
                                    <thead>
                                        <th
                                            class="text-lg text-white w-full bg-blue-500 rounded-tl-2xl border-teal border-b-2 border-r-2"
                                        >
                                            Side-effect
                                        </th>
                                        <th
                                            class="text-lg text-white w-full bg-blue-500 rounded-tr-2xl border-teal border-b-2 border-l px-4"
                                        ></th>
                                    </thead>
                                    <tbody>
                                        <tr
                                        ...
                                        >
                                            <td
                                                class="border-blue-300 border-2 py-1 px-2"
                                            >
                                                {{ effect }}
                                            </td>
                                            <td
                                            ...
                                            >
                                                <button
                                                    @click="rm_effect(effect)"
                                                    class="text-white shadow-lg transition duration-300 ease-in-out bg-pink-700 hover:bg-red-600 transform hover:-translate-y-1 hover:scale-110 rounded-lg py-1 px-4 m-1"
                                                >
                                                    remove
                                                </button>
                                            </td>
                        ...
                        <tr class="shadow-2xl">
                            <td
                                class="border-teal-500 border-0 text-pink-300 bg-blue-500 rounded-b-2xl"
                                colspan="3"
                            >
                                <button
                                    v-if="create_mode"
            ...
            >
                ...
                >
                    ...
                    <tbody>
                        ...
                        <tr class="bg-blue-100">
                            <td class="border-blue-300 border-2 py-3">
                                <label class="mr-3" for="select"
                                    ><b>Organ System:</b></label
                                >
                            </td>
                            <td class="border-blue-300 border-2 py-1">
                                <select
                                ...
                                >
                                    ...
                                    <option name="resp" value="Respiratory">
                                        Respiratory
                                    </option>
                                    <option name="card" value="Cardiovascular">
                                        Cardiovascular
                                    </option>
                                    <option name="psych" value="Psychiatric">
                                        Psychiatric
                                    </option>
                                    <option name="gas" value="Gastrointestinal">
                                        Gastrointestinal
                                    </option>
                                    <option name="endo" value="Endocrine">
                                        Endocrine
                                    </option>
                                    <option name="skel" value="Skeletal">
                                        Respiratory
                                    </option>
                                    <option name="musc" value="Muscular">
                                        Muscular
                                    </option>
                                    <option name="nerv" value="Nervous">
                                        Nervous
                                    </option>
                                    <option name="skin" value="Integumentary">
                                        Integumentary
                                    </option>
                                    <option name="lymp" value="Lymphatic">
                                        Lymphatic
                                    </option>
                                    <option name="urin" value="Urinary">
                                        Urinary
                                    </option>
                                    <option name="repo" value="Reproductive">
                                        Reproductive
                                    </option>
                                </select>
                            </td>
                        ...
                        <tr class="bg-blue-100">
                            <td class="border-blue-300 border-2 py-4">
                                ...
                                >
                                    <b>Add Symptom(s)</b>
                                    <i class="text-gray-400">(optional)</i>
                                </label>
                                <br />
                                <input
                                    class="border border-black mb-2 mt-2 p-1 rounded-lg"
...
export default {
    ...
    methods: {
        ...
        rm_effect(effect) {
            let temp_array = this.effects;
            this.effects = [];

            for (let i = 0; i < temp_array.length; i++) {
                if (temp_array[i] != effect) {
                    this.effects.push(temp_array[i]);
                }
            }
