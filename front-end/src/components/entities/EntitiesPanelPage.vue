    ...
    <div id="Entities_forms">
        ...
        <div v-if="logged_in">
            <div class="flex flex-col items-center">
                <p class="text-5xl mt-20 md-10">Update {{ entity_type }}s</p>
                <div class="flex flex-col items-center pt-10 w-full mt-10 mb-4">
                    <table class="w-full ml-auto md: mr-auto md:w-3/4 2xl:w-1/2 mb-3 rounded-b-none shadow-lg">
                        <thead>
                            <tr>
                                <th class="text-lg text-black bg-blue-500 rounded-tl-2xl border-teal border-b-2 border-r-2 px-4" colspan="3"> 
                                    <input
                                ...
                                <th class="text-lg text-white w-1/12 bg-blue-500 rounded-tr-2xl border-teal border-b-2 border-l-2">
                                    <router-link :to="{name: 'add-new-entity',params: { entity_type: entity_type, user_type:user_type, create_mode:true, query_string: query_string }}"
                        ...
                        <tbody>
                            ...
                            <tr class="bg-blue-100"
                                ...
                                <template v-if="entity_type == 'medication'">
                                    ...
                                    <td v-if="entity.Is_prescription == 1" class="border-teal-500 border-2 bg-green-300">
                                        YES
                                    </td>
                                ...
                                <td class="border-blue-400 border-2 p-2">
                                    <router-link :to="{name: 'add-new-entity',params: { entity_type: entity_type, user_type:user_type, create_mode:false, entity_name: entity.Name, Organ_system: entity.Organ_system, is_presc: entity.Is_prescription, effects: entity.Effects, query_string: query_string }}"
