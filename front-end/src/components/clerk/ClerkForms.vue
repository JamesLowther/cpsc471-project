    ...
    <div id="forms">
        ...
        <div v-if="logged_in">
            <div class="flex flex-col items-center">
                <p class="text-4xl lg:text-5xl mt-20 mb-24">
                    Clerk Workstation
                </p>
                ...
                <div class="w-full lg:w-4/5">
                    ...
                    <table
                        class="shadow-2xl table-auto w-full h-full mb-10 border-black"
                    >
                        <thead>
                            <tr class="h-14">
                                <th
                                    class="text-white bg-blue-500 rounded-tl-2xl border-teal border-b-2 border-l-2"
                                >
                                    Patient SSN
                                </th>
                                <th
                                    class="text-white bg-blue-500 border-teal border-b-2 border-l-2"
                                >
                                    Patient Name
                                </th>
                                <th
                                ...
                                <th
                                    class="text-white bg-blue-500 rounded-tr-2xl border-teal border-b-2 border-l-2"
                                >
                                    Report ID
                                </th>
                            </tr>
                        ...
                        <tbody>
                            <tr
                                v-for="patient in forms"
                                v-bind:key="patient.P_SSN"
                                class="h-10"
                            >
                                <td
                                    class="bg-blue-100 border-blue-300 border-2"
                                >
                                    {{ patient.P_SSN }}
                                </td>
                                <td
                                    class="bg-blue-100 border-blue-300 border-2"
                                >
                                    <div v-if="patient.Lname">
                                        {{ patient.Lname }}, {{ patient.Fname }}
                                    </div>
                                    <div
                                        v-else
                                        class="bg-red-200 w-2/3 inline-block m-2 rounded"
                                    >
                                        N/A
                                    </div>
                                </td>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                class="text-white px-1 py-1 my-2 shadow-lg transition duration-300 ease-in-out bg-gray-600 hover:bg-blue-500 rounded-lg"
                                            >
                                                View/Edit
                                            </div>
                                        </router-link>
                                    ...
                                    <div
                                        v-else-if="patient.Is_approved == 0"
                                        class="flex flex-wrap items-center justify-around"
                                    >
                                        <p
                                            class="bg-yellow-300 lg:w-2/5 px-1 py-1 rounded"
                                        >
                                            Pending
                                        </p>
                                        <router-link
                                        ...
                                        >
                                            <div
                                                class="text-white px-1 py-1 my-2 shadow-lg transition duration-300 ease-in-out bg-gray-600 hover:bg-yellow-500 rounded-lg"
                                            >
                                                View & Approve
                                            </div>
                                        </router-link>
                                    ...
                                    >
                                        <p
                                            class="bg-red-300 lg:w-2/5 px-1 py-1 rounded"
                                        >
                                            Not Submitted
                                        </p>
                                        <router-link
                                        ...
                                        >
                                            <div
                                                class="text-white px-1 py-1 my-2 shadow-lg transition duration-300 ease-in-out bg-gray-600 hover:bg-green-500 rounded-lg"
                                            >
                                                Create New
                                            </div>
                                        </router-link>
                                ...
                                >
                                    ...
                                    <div v-if="patient.TPAL_total != null">
                                        ...
                                        >
                                            <div
                                                class="w-4/5 mx-auto my-2 mx-1 shadow-lg transition duration-300 ease-in-out bg-green-300 hover:bg-blue-500 rounded-lg py-1 px-1"
                                            >
                                                View/Edit
                                            </div>
                                        </router-link>
                                    ...
                                    <div v-else>
                                        ...
                                        >
                                            <div
                                                class="w-4/5 mx-auto my-2 mx-1 shadow-lg transition duration-300 ease-in-out bg-red-200 hover:bg-green-500 rounded-lg py-1 px-1"
                                            >
                                                Create New
                                            </div>
                                        </router-link>
                                ...
                                >
                                    ...
                                    >
                                        <p
                                            class="bg-red-200 lg:w-2/5 px-1 py-1 rounded"
                                        >
                                            N/A
                                        </p>
                                        <button
